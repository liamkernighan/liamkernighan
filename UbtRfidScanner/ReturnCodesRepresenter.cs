...
{
    internal static class ReturnCodesRepresenter
    {
        ...
        public static string ToReturnCodeDescription(this int cmdRet)
        {
            switch (cmdRet)
            {
                case -10:
        ...
        public static string ToErrorDescription(this int cmdRet)
        {
            switch (cmdRet)
            {
                case 0x00:
